...
typedef enum ParsecStatus {
	...
	AES_GCM_ERR_PARSEC_KEY_LEN       = -28000,  ///< -28000
...
typedef enum ParsecLogLevel {
	PARSEC_LOG_INFO      = 0x0069, ///< Messages interesting to support staff trying to figure out the context of an issue.
	PARSEC_LOG_DEBUG     = 0x0064, ///< Messages interesting to developers trying to debug an issue.
	__PARSEC_LOG_MAKE_32 = 0x7FFFFFFF,
} ParsecLogLevel;
...
typedef enum ParsecKeycode {
	...
	PARSEC_KEY_9           = 38,  ///< 38
	PARSEC_KEY_0           = 39,  ///< 39
	PARSEC_KEY_ENTER       = 40,  ///< 40
	PARSEC_KEY_ESCAPE      = 41,  ///< 41
	PARSEC_KEY_BACKSPACE   = 42,  ///< 42
	PARSEC_KEY_TAB         = 43,  ///< 43
	PARSEC_KEY_SPACE       = 44,  ///< 44
	PARSEC_KEY_MINUS       = 45,  ///< 45
	PARSEC_KEY_EQUALS      = 46,  ///< 46
	PARSEC_KEY_LBRACKET    = 47,  ///< 47
	PARSEC_KEY_RBRACKET    = 48,  ///< 48
	PARSEC_KEY_BACKSLASH   = 49,  ///< 49
	PARSEC_KEY_SEMICOLON   = 51,  ///< 51
	PARSEC_KEY_APOSTROPHE  = 52,  ///< 52
	PARSEC_KEY_BACKTICK    = 53,  ///< 53
	PARSEC_KEY_COMMA       = 54,  ///< 54
	PARSEC_KEY_PERIOD      = 55,  ///< 55
	PARSEC_KEY_SLASH       = 56,  ///< 56
	PARSEC_KEY_CAPSLOCK    = 57,  ///< 57
	PARSEC_KEY_F1          = 58,  ///< 58
	PARSEC_KEY_F2          = 59,  ///< 59
	PARSEC_KEY_F3          = 60,  ///< 60
	PARSEC_KEY_F4          = 61,  ///< 61
	...
	PARSEC_KEY_F8          = 65,  ///< 65
	PARSEC_KEY_F9          = 66,  ///< 66
	PARSEC_KEY_F10         = 67,  ///< 67
	PARSEC_KEY_F11         = 68,  ///< 68
	PARSEC_KEY_F12         = 69,  ///< 69
	PARSEC_KEY_PRINTSCREEN = 70,  ///< 70
	PARSEC_KEY_SCROLLLOCK  = 71,  ///< 71
	PARSEC_KEY_PAUSE       = 72,  ///< 72
	PARSEC_KEY_INSERT      = 73,  ///< 73
	PARSEC_KEY_HOME        = 74,  ///< 74
	PARSEC_KEY_PAGEUP      = 75,  ///< 75
	PARSEC_KEY_DELETE      = 76,  ///< 76
	PARSEC_KEY_END         = 77,  ///< 77
	PARSEC_KEY_PAGEDOWN    = 78,  ///< 78
	PARSEC_KEY_RIGHT       = 79,  ///< 79
	PARSEC_KEY_LEFT        = 80,  ///< 80
	PARSEC_KEY_DOWN        = 81,  ///< 81
	PARSEC_KEY_UP          = 82,  ///< 82
	PARSEC_KEY_NUMLOCK     = 83,  ///< 83
	PARSEC_KEY_KP_DIVIDE   = 84,  ///< 84
	PARSEC_KEY_KP_MULTIPLY = 85,  ///< 85
	PARSEC_KEY_KP_MINUS    = 86,  ///< 86
	PARSEC_KEY_KP_PLUS     = 87,  ///< 87
	PARSEC_KEY_KP_ENTER    = 88,  ///< 88
	PARSEC_KEY_KP_1        = 89,  ///< 89
	PARSEC_KEY_KP_2        = 90,  ///< 90
	PARSEC_KEY_KP_3        = 91,  ///< 91
	PARSEC_KEY_KP_4        = 92,  ///< 92
	PARSEC_KEY_KP_5        = 93,  ///< 93
	PARSEC_KEY_KP_6        = 94,  ///< 94
	PARSEC_KEY_KP_7        = 95,  ///< 95
	PARSEC_KEY_KP_8        = 96,  ///< 96
	PARSEC_KEY_KP_9        = 97,  ///< 97
	PARSEC_KEY_KP_0        = 98,  ///< 98
	PARSEC_KEY_KP_PERIOD   = 99,  ///< 99
	PARSEC_KEY_APPLICATION = 101, ///< 101
	PARSEC_KEY_F13         = 104, ///< 104
	PARSEC_KEY_F14         = 105, ///< 105
	PARSEC_KEY_F15         = 106, ///< 106
	PARSEC_KEY_F16         = 107, ///< 107
	PARSEC_KEY_F17         = 108, ///< 108
	PARSEC_KEY_F18         = 109, ///< 109
	PARSEC_KEY_F19         = 110, ///< 110
	PARSEC_KEY_MENU        = 118, ///< 118
	PARSEC_KEY_MUTE        = 127, ///< 127
	PARSEC_KEY_VOLUMEUP    = 128, ///< 128
	PARSEC_KEY_VOLUMEDOWN  = 129, ///< 129
	PARSEC_KEY_LCTRL       = 224, ///< 224
	PARSEC_KEY_LSHIFT      = 225, ///< 225
	PARSEC_KEY_LALT        = 226, ///< 226
	PARSEC_KEY_LGUI        = 227, ///< 227
	PARSEC_KEY_RCTRL       = 228, ///< 228
	PARSEC_KEY_RSHIFT      = 229, ///< 229
	PARSEC_KEY_RALT        = 230, ///< 230
	PARSEC_KEY_RGUI        = 231, ///< 231
	PARSEC_KEY_AUDIONEXT   = 258, ///< 258
	PARSEC_KEY_AUDIOPREV   = 259, ///< 259
	PARSEC_KEY_AUDIOSTOP   = 260, ///< 260
	PARSEC_KEY_AUDIOPLAY   = 261, ///< 261
	PARSEC_KEY_AUDIOMUTE   = 262, ///< 262
	PARSEC_KEY_MEDIASELECT = 263, ///< 263
	__PARSEC_KEY_MAKE_32   = 0x7FFFFFFF,
} ParsecKeycode;
